...
\draw [red, dashed] ({rel axis cs:0,0}|-{axis cs:0,104.354}) -- ({rel axis cs:1,0}|-{axis cs:10,104.354}) node [pos=0.5, above] {Lower bound};
  \end{axis}
\end{tikzpicture}
...
\draw [red, dashed] ({rel axis cs:0,0}|-{axis cs:0,138.674}) -- ({rel axis cs:1,0}|-{axis cs:10,138.674}) node [pos=0.5, above] {Lower bound};
  \end{axis}
\end{tikzpicture}
...
\draw [red, dashed] ({rel axis cs:0,0}|-{axis cs:0,92.6074}) -- ({rel axis cs:1,0}|-{axis cs:10,92.6074}) node [pos=0.5, above] {Lower bound};
  \end{axis}
\end{tikzpicture}
\caption*{Average weights repartitions on one of the trees}
\end{minipage}
...
\draw [red, dashed] ({rel axis cs:0,0}|-{axis cs:0,100.711}) -- ({rel axis cs:1,0}|-{axis cs:10,100.711}) node [pos=0.5, above] {Lower bound};
  \end{axis}
\end{tikzpicture}
\caption*{Average weights repartitions on one of the trees}
\end{minipage}
