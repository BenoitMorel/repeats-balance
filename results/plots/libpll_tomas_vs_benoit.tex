...
\subimport{../sequential_benchs/}{bench_tomas_vs_benoit_100_cpu.tex}
\end{figure}

\begin{figure}[!htb]
\figuretitle{AVX architecture (computer: my hits computer), 100 iterations}
\subimport{../sequential_benchs/}{bench_tomas_vs_benoit_100_avx.tex}
\end{figure}

\begin{figure}[!htb]
\figuretitle{SSE architecture (computer: my hits computer), 100 iterations}
\subimport{../sequential_benchs/}{bench_tomas_vs_benoit_100_sse.tex}
\end{figure}
